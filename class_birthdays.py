# Given Person class with name,age and birthday month, write below functions:
#  1. To retrive people with birthdays in April 
#  2. To retrieve the most common birthday month
...
def get_most_common_month(people):
    ...
    largest = sorted(months.values()).pop()
